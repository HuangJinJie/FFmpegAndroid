...
JNIEXPORT jint JNICALL Java_com_jacket_ffmpegandroidcameralive_WSPlayer_initialize
...
JNIEXPORT jint JNICALL Java_com_jacket_ffmpegandroidcameralive_WSPlayer_start
...
JNIEXPORT jint JNICALL Java_com_jacket_ffmpegandroidcameralive_WSPlayer_stop
...
JNIEXPORT jint JNICALL Java_com_jacket_ffmpegandroidcameralive_WSPlayer_close
        (JNIEnv *env, jobject obj) {
    if (video_st)
